...
request_controler = Blueprint("request_controler", __name__)


@request_controler.route("/api/request", methods=["GET","POST"])
...
@request_controler.route("api/request/add/<int:initiator_id>/<int:request_time>/<int:price>", methods = ["GET","POST"])
...
@request_controler.route("api/request/remove/<int:request_id>", methods = ["POST"])
